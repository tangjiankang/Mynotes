...
环境：ubuntu 18.04,k8s 1.16.1,docker 18.09 数据盘使用xfs格式 一、服务器优化 cat /etc/sysctl.conf
...
cat /etc/kubernetes/manifests/kube-apiserver.yaml `- --service-node-port-range=500-65535`
