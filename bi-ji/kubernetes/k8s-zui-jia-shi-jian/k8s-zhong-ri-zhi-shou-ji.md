...
[http://kafka.apache.org/quickstart](http://kafka.apache.org/quickstart) 1.下载，解压 sudo tar zxf kafka\_2.11-2.4.0.tgz -C /opt/ 2.安装supervisor apt update && apt install supervisor 修改配置文件 cat /etc/supervisor/supervisord.conf
