...
server {
   listen 80 ;
    server_name support.lwork.com;

location /{
                 rewrite ^(.*) https://support.lwork.com$1 permanent;
        }
...
server {
    ...
    ssl on;
    ssl_certificate /etc/ssl/support.lwork.com.crt;
    ssl_certificate_key /etc/ssl/support.lwork.com.key;
    ...
    location =/ {
        proxy_pass http://static-sc.lwork.com/prod/dist/$ui_version/index/index.html;
        proxy_redirect off;
      }
    ...
    proxy_pass http://static-sc.lwork.com/prod/dist/$ui_version/bridge/index.html;
    proxy_redirect off;
    }
